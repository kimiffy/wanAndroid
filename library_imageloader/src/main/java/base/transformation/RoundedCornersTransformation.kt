 ...
 * File Name:    RoundedCornersTransformation.java
 * ClassName:    RoundedCornersTransformation
 *
 * Description: 圆角变换
 *
 * @author 唐晓辉
...
class RoundedCornersTransformation @JvmOverloads constructor(private val radius: Int, private val margin: Int, private val cornerType: CornerType = CornerType.ALL) : BitmapTransformation() {
    ...
    companion object {
        private const val ID = "glide.transformations.RoundedCornersTransformation"
    }
